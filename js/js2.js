...
function requestApi(city, language) {
  fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=2cac11ac1d827b200596549c722d6549&lang=ru`)
    ...
    .then(function (data_lang) {
      ...
      fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=2cac11ac1d827b200596549c722d6549&lang=en`)
